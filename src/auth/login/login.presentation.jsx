...
class Login extends AutobindComponent {
  render() {
    ...
    const loginRequired =
      !newPasswordRequired && !attributesRequired && !mfaRequired;
    ...
    return (
      <div className={styles.loginPage}>
        ...
        >
          {formsProps => [
            loginRequired ? (
              <LoginSection key='loginSection' {...formsProps} />
            ) : null,
            newPasswordRequired ? (
              <NewPasswordSection key='newPasswordSection' {...formsProps} />
            ) : null,
            attributesRequired ? (
              <AdditionalAttributesSection
                key='additionalAttrSection'
                {...formsProps}
                {...this.props}
              />
            ) : null,
            mfaRequired ? (
              <MFASection key='mfaSection' {...formsProps} />
            ) : null,
          ]}
        </Form>
        <Link
...
Login.propTypes = LoginSection.propTypes = MFASection.propTypes = AdditionalAttributesSection.propTypes = NewPasswordSection.propTypes = Login.propTypes = {
