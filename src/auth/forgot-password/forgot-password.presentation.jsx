  ...
  render() {
    ...
    return (
      <div className={ styles.forgotPasswordPage }>
        <Form
          form={FORGOT_PASSWORD_FORM_NAME} onSubmit={ forgotPassword }
          header={ t('forgotPassword:Reset Password') } submitLabel={ t('forgotPassword:Reset Password') }
          validate={ forgotPasswordValidate }
        >
          <Field
            required={ true } component={ FormField }
            type="text" name="username" label={ t('forgotPassword:Username') }
          />
        </Form>
      </div>
      )
